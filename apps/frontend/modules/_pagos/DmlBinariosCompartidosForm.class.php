...
/**
 * DmlBinariosCompartidos formulario.
 *
 * @package    dml
 * @subpackage form
 ...
 */
class DmlBinariosCompartidosForm extends BaseDmlBinariosCompartidosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['bc_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['bc_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['bc_fecha_borra']    = new sfWidgetFormInputText();
    }
