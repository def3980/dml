...
<?php echo str_repeat('    ', 5) ?><div id="modal<?=$idFa?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="text-align: center">
...
<?php echo str_repeat('    ', 5) ?>        <?php include_partial('modal_body_facturas', array('idFa' => $idFa)) ?>
<?php echo str_repeat('    ', 5) ?>    </div>
