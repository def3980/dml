...
<?php echo str_repeat('    ', 7) ?>    <tbody><?php foreach (DmlBinariosTable::getBinYFactura($idFa)->execute(null, 5) as $k => $v): echo PHP_EOL; ?>
...
<?php echo str_repeat('    ', 7) ?>            <td style="width: 15%; text-align: center;"><a id-bi="<?=$v['bi_id']?>" id-fa="<?=$v['fa_id']?>" href="javascript:void(0)" class="btn btn-small"><i class="icon-trash"></i></a></td>
