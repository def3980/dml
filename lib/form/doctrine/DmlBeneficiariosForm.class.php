 ...
 */
class DmlBeneficiariosForm extends BaseDmlBeneficiariosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['be_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['be_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['be_fecha_borra']    = new sfWidgetFormInputText();
    }
