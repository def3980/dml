...
/**
 * DmlContratosBancarios formulario.
 *
 * @package    dml
 * @subpackage form
 ...
 */
class DmlContratosBancariosForm extends BaseDmlContratosBancariosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['cb_fecha_contrato'] = new sfWidgetFormInputText();
        $this->widgetSchema['cb_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['cb_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['cb_fecha_borra']    = new sfWidgetFormInputText();
    }
