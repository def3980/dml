 ...
 */
class DmlDetallePagosForm extends BaseDmlDetallePagosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['dp_fecha']          = new sfWidgetFormInputText();
        $this->widgetSchema['dp_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['dp_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['dp_fecha_borra']    = new sfWidgetFormInputText();
    }
