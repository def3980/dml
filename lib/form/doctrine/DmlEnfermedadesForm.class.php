 ...
 */
class DmlEnfermedadesForm extends BaseDmlEnfermedadesForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['ef_fecha']          = new sfWidgetFormInputText();
        $this->widgetSchema['ef_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['ef_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['ef_fecha_borra']    = new sfWidgetFormInputText();
    }
