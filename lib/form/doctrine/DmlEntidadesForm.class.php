 ...
 */
class DmlEntidadesForm extends BaseDmlEntidadesForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['en_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['en_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['en_fecha_borra']    = new sfWidgetFormInputText();
    }
