 ...
 */
class DmlHijosForm extends BaseDmlHijosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['hi_fecha_nacimiento'] = new sfWidgetFormInputText();
        $this->widgetSchema['hi_fecha_crea']       = new sfWidgetFormInputText();
        $this->widgetSchema['hi_fecha_modifica']   = new sfWidgetFormInputText();
        $this->widgetSchema['hi_fecha_borra']      = new sfWidgetFormInputText();
    }
