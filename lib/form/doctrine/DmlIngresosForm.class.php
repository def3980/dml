 ...
 */
class DmlIngresosForm extends BaseDmlIngresosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['in_fecha']          = new sfWidgetFormInputText();
        $this->widgetSchema['in_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['in_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['in_fecha_borra']    = new sfWidgetFormInputText();
    }
