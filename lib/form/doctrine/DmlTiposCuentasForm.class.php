 ...
 */
class DmlTiposCuentasForm extends BaseDmlTiposCuentasForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['tc_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['tc_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['tc_fecha_borra']    = new sfWidgetFormInputText();
    }
