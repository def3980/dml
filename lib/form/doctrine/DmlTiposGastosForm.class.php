 ...
 */
class DmlTiposGastosForm extends BaseDmlTiposGastosForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['tg_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['tg_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['tg_fecha_borra']    = new sfWidgetFormInputText();
    }
