...
/**
 * DmlTiposTarjetasCreditoDebito formulario.
 *
 * @package    dml
 * @subpackage form
 ...
 */
class DmlTiposTarjetasCreditoDebitoForm extends BaseDmlTiposTarjetasCreditoDebitoForm {
    ...
    public function configure() {
        ...
        $this->widgetSchema['ttcd_fecha_crea']     = new sfWidgetFormInputText();
        $this->widgetSchema['ttcd_fecha_modifica'] = new sfWidgetFormInputText();
        $this->widgetSchema['ttcd_fecha_borra']    = new sfWidgetFormInputText();
    }
